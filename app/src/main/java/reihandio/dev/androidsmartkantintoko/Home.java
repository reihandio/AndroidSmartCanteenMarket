...
import reihandio.dev.androidsmartkantintoko.ViewHolder.MenuViewHolder;
...
public class Home extends AppCompatActivity
    ...
    private void showDialog() {
        ...
        alertDialog.setTitle("Buat Toko Baru");
        ...
        alertDialog.setPositiveButton("Simpan", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                if(newCategory != null)
                {
                    ...
                    Snackbar.make(drawer, "Toko Baru "+newCategory.getName()+" berhasil ditambahkan",Snackbar.LENGTH_SHORT)
                            .show();
                }
            }
        });
            ...
            imageFolder.putFile(saveUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            mDialog.dismiss();
                            Toast.makeText(Home.this, "Berhasil Upload!", Toast.LENGTH_SHORT).show();
            ...
            protected void populateViewHolder(MenuViewHolder viewHolder, Category model, int position) {
                ...
                viewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        //kirim kategori ID dan start new activity
...
//        }
    ...
    private void showUpdateDialog(final String key, final Category item) {
        AlertDialog.Builder alertDialog = new AlertDialog.Builder(Home.this);
        alertDialog.setTitle("Update Baru");
        alertDialog.setMessage("Mohon Isi Informasi");
